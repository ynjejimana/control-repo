class apache2::mod::passenger (
  $passenger_conf_file              = $::apache2::params::passenger_conf_file,
  $passenger_conf_package_file      = $::apache2::params::passenger_conf_package_file,
  ...
  $passenger_root                   = $::apache2::params::passenger_root,
  $passenger_ruby                   = $::apache2::params::passenger_ruby,
  $passenger_default_ruby           = $::apache2::params::passenger_default_ruby,
  ...
  if $passenger_conf_package_file {
    file { 'passenger_package.conf':
      path => "${::apache2::confd_dir}/${passenger_conf_package_file}",
    }
  }
  ...
  file { 'passenger.conf':
    ...
    path    => "${::apache2::mod_dir}/${passenger_conf_file}",
    content => template('apache2/mod/passenger.conf.erb'),

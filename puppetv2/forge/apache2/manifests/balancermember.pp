# == Define Resource Type: apache2::balancermember
#
...
#
# [*balancer_cluster*]
# The apache service's instance name (or, the title of the apache2::balancer
# resource). This must match up with a declared apache2::balancer resource.
#
# [*url*]
...
#
# @@apache2::balancermember { 'apache':
#   balancer_cluster => 'puppet00',
#   url              => "ajp://${::fqdn}:8009"
#   options          => ['ping=5', 'disablereuse=on', 'retry=5', 'ttl=120'],
# }
#
define apache2::balancermember(
  $balancer_cluster,
  $url = "http://${::fqdn}/",
  $options = [],
) {

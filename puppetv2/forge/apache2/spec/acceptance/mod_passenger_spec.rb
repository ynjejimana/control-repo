...
describe 'apache2::mod::passenger class' do
  pending 'This cannot run in the same test run as apache2::vhost with passenger
  ...
  pp_rackapp = <<-EOS
    ...
    apache2::vhost { 'passenger.example.com':
      port          => '80',

...
describe 'apache2::mod::security class', :unless => (fact('osfamily') == 'Debian' and (fact('lsbdistcodename') == 'squeeze' or fact('lsbdistcodename') == 'lucid' or fact('lsbdistcodename') == 'precise' or fact('lsbdistcodename') == 'wheezy')) do
  context "default mod_security config" do
    ...
    it 'succeeds in puppeting mod_security' do
      pp= <<-EOS
        ...
        apache2::vhost { 'modsec.example.com':
          port    => '80',
...
end #apache2::mod::security class

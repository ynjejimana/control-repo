...
describe 'apache2::mod::wsgi', :type => :class do
  ...
  context "on a Debian OS" do
    ...
    it { is_expected.to contain_class('apache2::mod::wsgi').with(
  ...
  context "on a RedHat OS" do
    ...
    describe "with package_name but no mod_path" do
      ...
      it { expect { catalogue }.to raise_error Puppet::Error, /apache2::mod::wsgi - both package_name and mod_path must be specified!/ }
    end

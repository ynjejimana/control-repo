...
describe 'apache2::vhost', :type => :define do
  let :pre_condition do
    'class { "apache": default_vhost => false, default_mods => false, vhost_enable_dir => "/etc/apache/sites-enabled"}'
  end
  let :title do
    'rspec.example.com'
  end
  ...
  describe 'os-dependent items' do
    ...
    context "on Debian based systems" do
      ...
      it { is_expected.to contain_concat("25-rspec.example.com.conf").with(
        :ensure => 'present',
        :path   => '/etc/apache/sites-available/25-rspec.example.com.conf'
      ) }
      it { is_expected.to contain_file("25-rspec.example.com.conf symlink").with(
        :ensure => 'link',
        :path   => '/etc/apache/sites-enabled/25-rspec.example.com.conf',
        :target => '/etc/apache/sites-available/25-rspec.example.com.conf'
      ) }
    end
    context "on FreeBSD systems" do
      ...
      it { is_expected.to contain_concat("25-rspec.example.com.conf").with(
        :ensure => 'present',
        :path   => '/usr/local/etc/apache4/Vhosts/25-rspec.example.com.conf'
      ) }
    end
    context "on Gentoo systems" do
      ...
      it { is_expected.to contain_concat("25-rspec.example.com.conf").with(
        :ensure => 'present',
        :path   => '/etc/apache/vhosts.d/25-rspec.example.com.conf'
      ) }
    end
  end
  describe 'os-independent items' do
    ...
    context 'set everything!' do
      ...
      it { is_expected.to contain_class('apache2::mod::ssl') }
      ...
      it { is_expected.to contain_class('apache2::mod::vhost_alias') }
      it { is_expected.to contain_class('apache2::mod::wsgi') }
      it { is_expected.to contain_class('apache2::mod::suexec') }
      it { is_expected.to contain_class('apache2::mod::passenger') }
      it { is_expected.to contain_file('/var/www/logs').with({
        'ensure' => 'directory',
        'mode'   => '0600',
      })
      }
      it { is_expected.to contain_class('apache2::mod::rewrite') }
      it { is_expected.to contain_class('apache2::mod::alias') }
      it { is_expected.to contain_class('apache2::mod::proxy') }
      it { is_expected.to contain_class('apache2::mod::proxy_http') }
      it { is_expected.to contain_class('apache2::mod::passenger') }
      it { is_expected.to contain_class('apache2::mod::passenger') }
      it { is_expected.to contain_class('apache2::mod::fastcgi') }
      it { is_expected.to contain_class('apache2::mod::headers') }
      it { is_expected.to contain_class('apache2::mod::filter') }
      it { is_expected.to contain_class('apache2::mod::setenvif') }
      ...
      it { is_expected.to contain_file('30-rspec.example.com.conf symlink').with({
        'ensure' => 'link',
        'path'   => '/etc/apache/sites-enabled/30-rspec.example.com.conf',
      })
      }
    ...
    context 'not everything can be set together...' do
      ...
      it { is_expected.to compile }
      it { is_expected.to_not contain_class('apache2::mod::ssl') }
      it { is_expected.to_not contain_class('apache2::mod::mime') }
      it { is_expected.to_not contain_class('apache2::mod::vhost_alias') }
      it { is_expected.to_not contain_class('apache2::mod::wsgi') }
      it { is_expected.to_not contain_class('apache2::mod::passenger') }
      it { is_expected.to_not contain_class('apache2::mod::suexec') }
      it { is_expected.to_not contain_class('apache2::mod::rewrite') }
      it { is_expected.to_not contain_class('apache2::mod::alias') }
      it { is_expected.to_not contain_class('apache2::mod::proxy') }
      it { is_expected.to_not contain_class('apache2::mod::proxy_http') }
      it { is_expected.to_not contain_class('apache2::mod::passenger') }
      it { is_expected.to_not contain_class('apache2::mod::headers') }

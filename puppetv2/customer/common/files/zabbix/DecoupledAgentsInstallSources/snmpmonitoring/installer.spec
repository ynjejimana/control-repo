...
CLASS = snmp_proxy_generic
DESCRIPTION = Zabbix SNMP V2 Proxy Generic Installer (as per https://wiki.lab.com.au/display/ENG/Network+Monitoring+V2)
...
PERL_REQUIRED_MODULE = Time::Seconds
PERL_REQUIRED_MODULE = Time::HiRes
PERL_REQUIRED_MODULE = threads
PERL_REQUIRED_MODULE = threads::shared
PERL_REQUIRED_MODULE = Net::SNMP


# Relevant Puppet class that deploys this Zabbix Proxy VM and runs installer.pl
PUPPET_CLASS_GIT_DIR = "/customer/common/manifests/zabbix/snmp_proxy_generic.pp"
...
# 1) Ensure "Timeout = 10" in zabbix_agentd.conf and zabbix_proxy.conf
# 2) Register proxy in Zabbix
# 3) Add new network devices to monitoring as per documentation

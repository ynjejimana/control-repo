#!/usr/bin/perl
#### Semi-automated Zabbix Proxy core functionality installer (for Network Monitoring V2 Proxy)
#### Version 1.46
...
our $coreScriptsDestinationDir = "/srv/zabbix/scripts/snmpmonitoring";
...
my $installerLockFile =
  $installerLocksDir . "/91c2eb25-029b-4662-b2c5-340acf0d5d29";
...
#	my $cpanExtraModules1 = ' Net::SNMP Net::Telnet';
...
## install snmpmonitoring-get-data.pl

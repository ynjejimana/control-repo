...
CLASS = zfs_proxy_generic
DESCRIPTION = Oracle ZFS Storage Monitoring V1 - Zabbix Proxy Generic Installer (documented at https://wiki.lab.com.au/display/ENG/Oracle+ZFS+Monitoring+V1)
...
PUPPET_CLASS_GIT_DIR = "/customer/common/manifests/zabbix/zfs_proxy_generic.pp"

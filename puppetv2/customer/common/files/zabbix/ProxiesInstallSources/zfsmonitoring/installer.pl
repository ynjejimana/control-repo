#!/usr/bin/perl
#### Semi-automated Zabbix Proxy core functionality installer (for Oracle ZFS Monitoring V1 Proxy)
#### Version 1.25
...
our $coreScriptsDestinationDir = "/srv/zabbix/scripts/zfsmonitoring";
...
my $installerLockFile =
  $installerLocksDir . "/71f69195-3a72-4ccd-9445-2128c3875f5a";

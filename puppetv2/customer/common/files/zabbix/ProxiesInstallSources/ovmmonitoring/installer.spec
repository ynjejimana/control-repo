...
CLASS = ovm_proxy_generic
DESCRIPTION = Zabbix OVM V2 Proxy Generic Installer (as per https://wiki.lab.com.au/display/ENG/Monitoring+OVM+V.2)
...
PUPPET_CLASS_GIT_DIR = "/customer/common/manifests/zabbix/ovm_proxy_generic.pp"
...
# 2) Add new hypervisors to monitoring as per documentation

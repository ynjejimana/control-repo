#!/usr/bin/perl
#### Semi-automated Zabbix Proxy core functionality installer (for Utilities Monitoring V1 Proxy)
#### Version 1.14
...
our $coreScriptsDestinationDir = "/srv/zabbix/scripts/utilitiesmonitoring";
...
my $installerLockFile =
  $installerLocksDir . "/5926bf18-256d-4e9c-af30-a48f0caa37e4";
...
#' ExtUtils::MakeMaker Net::SMTP Net::DNS::Dig NetAddr::IP::Util Net::NTP Date::Calc IO::Pty';
#
...
## install monitoring script
	...
	$tmpFileName = 'collect-postfix-stats.pl';

#!/usr/bin/perl
#### Semi-automated Zabbix Proxy core functionality installer (for Graylog Cluster Monitoring V1 Proxy)
#### Version 1.6
...
our $coreScriptsDestinationDir = "/srv/zabbix/scripts/gcmonitoring";
...
my $installerLockFile =
  $installerLocksDir . "/82a073fc-c70b-4257-8b21-7fcc11ea376d";
...
'Config::Simple Data::Dumper Net::OpenSSH Time::Piece Time::HiRes DBI DBD::SQLite Date::Parse Date::Format';
	...
	my $cpanExtraModules1 = ' REST::Client JSON';

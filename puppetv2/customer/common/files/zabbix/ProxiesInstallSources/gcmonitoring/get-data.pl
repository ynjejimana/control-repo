#!/usr/bin/perl
#### Monitoring Graylog Cluster (HTTP service querying utility for automated Zabbix information retrieval)
#### Version 1.2
...
our $scriptsBaseDir = "/srv/zabbix/scripts/gcsmonitoring";
...
my $localDatabaseFileName = "$scriptsBaseDir/gcmonitoringdata.db";
my $localDatabaseDBH;

my $zpimDatabase1FileName = "$zpimBaseDir/zpimonitoring.db";
my $zpimZAgentPerf1Tracing_GCMonitoringGetDataAnchor1_GUID =
  '00372574-cb7c-4256-8e13-90a6118f5951';
my $zpimZAgentPerf1Tracing_GCMonitoringGetDataAnchor1_TimeStamp0;
...
## main execution block
	...
	zpimZAgentPerf1Entry(
		1,
		$zpimZAgentPerf1Tracing_GCMonitoringGetDataAnchor1_GUID,
		\$zpimZAgentPerf1Tracing_GCMonitoringGetDataAnchor1_TimeStamp0,
		$$,
		$commandline,
		undef
	);
